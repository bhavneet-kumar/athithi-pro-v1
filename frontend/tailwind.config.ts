  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        crm: {
          primary: '#9b87f5', // Changed main color to AthitiPRO primary purple
          secondary: '#7E69AB', // Changed to darker purple
          accent: '#F97316', // Orange accent
          neutral: '#64748B', // Gray/slate
          success: '#22C55E', // Green for positive actions
          warning: '#F59E0B', // Yellow for warnings
          danger: '#EF4444', // Red for errors/destructive actions
          light: '#F8FAFC', // Light background
          dark: '#1A1F2C', // Dark text/background (changed to match AthitiPRO dark)
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
